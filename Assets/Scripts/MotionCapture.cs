...
public class MotionCapture : MonoBehaviour
{
    ...
    {
        string path = Application.dataPath + "/MotionCheckData.json";
    ...
    {
        string path = Application.dataPath + "/CapturePoseData.json";
    ...
    public void LoadDataToHands(int i)
    {
        ...
        Debug.Log("ovrskeleton position : " + _ovrskeleton.Bones[(int)OVRSkeleton.BoneId.Hand_Thumb3].Transform.position);
        Debug.Log("ovrskeleton rotation: " + _ovrskeleton.Bones[(int)OVRSkeleton.BoneId.Hand_Thumb3].Transform.rotation);
        Debug.Log("ovrhand position : " + blt3.transform.position);
        Debug.Log("ovrhand rotation : " + blt3.transform.rotation);
    }
